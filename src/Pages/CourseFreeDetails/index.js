...
import img_course_details from "../../assets/Course/img_course_details.png"
import { Link } from "react-router-dom";
function CourseFreeDetails() {
    return (
        <>
            <div>
            ...
            <div className="max-w-[1390px] mx-auto pl-[24px] pr-[24px] flex pt-[100px] font-poppins">
                <div>
                    <div>
                        <img src={img_course_details} alt="anc"></img>
                    </div>
                    <div className="max-w-[850px] mx-auto pt-[50px]">
                        <h1 className="font-semibold text-[40px] leading-[60px]">Lời khuyên trước khóa học</h1>

                        <div>
                            <div class="flex flex-row">
                                <img class="object-cover w-12 h-12 border-2 border-gray-300 rounded-full" alt="Noob master's avatar"
                                    src="https://images.unsplash.com/photo-1517070208541-6ddc4d3efbcb?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&faces=1&faceindex=1&facepad=2.5&w=500&h=500&q=80"></img>
                            ...
                            <hr class="my-2 ml-16 border-gray-200"></hr>
                            <div class="flex flex-row pt-1 md-10 md:ml-16">
                                <img class="w-12 h-12 border-2 border-gray-300 rounded-full" alt="Emily's avatar"
                                    src="https://images.unsplash.com/photo-1581624657276-5807462d0a3a?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&fit=facearea&faces=1&faceindex=1&facepad=2.5&w=500&h=500&q=80"></img>
                                <div class="flex-col mt-1">
                ...
                <div className="max-w-[389px] ">
                    <div className="pl-[5px] pr-[5px]">
                        <h1 className="font-bold text-[25px] leading-[37.5px]"> Nội dung khóa học</h1>
                    </div>
                    <div>
                        <ul className="flex flex-col">
                            <li className="list-decimal pl-5">
                                ...
                                <ul className="list-decimal list-inside pl-5">
                                    <li>
                                        <Link>Lời khuyên trước khóa học</Link>
                                    </li>
                                    <li>
                                        <Link>Cài đặt môi trường</Link>
                                    </li>
                                </ul>
                            </li>
                            <li className="list-decimal pl-5">
...
export default CourseFreeDetails;