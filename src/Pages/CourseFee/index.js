...
function CourseFee(){
    return(
        ...
        <div className="bg-no-repeat" style={{ backgroundImage: `url(${bg_home})` }}>
                <LayoutHeader>
                    <div className="max-w-[1188px] mx-auto pl-[24px] pr-[24px] pt-[68px] pb-[120px]">
                       ...
                       <h1 className="font-semibold text-[50px] leading-[75px]">Cách dễ nhất để học HTML, CSS cơ bản cho người mới bắt đầu</h1>
                        ...
                        <div className="max-w-[525px] justify-between mx-auto flex pt-[50px]">
                            <div className="w-[233px] h-[52px] bg-[#191A23] rounded-[14px] font-semibold text-[16px] leading-[24px] tracking-[1.6px] text-center text-[#fff] pt-[15px]">Học thử miễn phí</div>
            ...
            <div className="max-w-[1398px] pl-[24px] pr-[24px] mx-auto mt-[280px] border border-black">
            ...
            <div className="max-w-[1398px] mx-auto pl-[24px] pr-[24px]">
